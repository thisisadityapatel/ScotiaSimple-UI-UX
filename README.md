...
ScotiaSimple
------------
ScotiaSimple app was designed using Adobe XD. Our main goal was to make a 'lite' version of the official Scotiabank App, which can be used by people in remote locations, where the network is not strong enough i.e. 2G and 3G. This would help people in the remote regions connect with online financial servies. 
We also wanted to make the app as simple to use as possible, since our ultimate goal was to reduce the digital divide, ex. Help Older Citizens connect with the financial world. 
